...
class AboutSymbols < Neo::Koan
  ...
  # If we created the symbol, then it obviously be include in the list of all symbols
  ...
  in_ruby_version("mri") do
    ...
    def test_constants_become_symbols
      ...
      # The name of the constant becomes a symbol, not its value
  ...
  # They will consume memory for the life of the program since they will never be garbage collected
end
