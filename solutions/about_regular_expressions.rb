...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why?
  # They try to match as much as they can of a string.
  ...
  # 1-based indexing of regular expressions is unexpected
  ...
  # Character classes match a single character out of several possible character
  # classes but alternation can match a single regular expression out of several
