...
class AboutClassMethods < Neo::Koan
  ...
  # This could be useful (though most would probably disagree)
  ...
  # class << self opens up self's singleton class (eigenclass).
  # I prefer the shorter self.xxx version.
  # You might want to use the class << self version when you want to specialize the
  # behaviour of methods of a specific object.
  # ------------------------------------------------------------------
