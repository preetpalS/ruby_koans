...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # It takes a value as an argument and a block.
    # It then uses the given value as the first block argument and
    # reduces the array with the block using each item of the array
