...
class AboutBlocks < Neo::Koan
  ...
  # This one area where blocks differ from lambda functions
  ...
  # Did not know about the alternative syntax presented in the following test
  ...
  def test_stand_alone_blocks_can_be_passed_to_methods_expecting_blocks
    ...
    assert_equal 'JIM', result # This one seems very weird but useful
  end
